        ...
        <>
            <div className='w-full flex justify-between items-center font-semifold'>
                ...
                <div className='flex items-center gap-4'>
                    <p className='bg-white text-black text-[15px] px-4 py-1 rounded-xl hidden md:block cursor-pointer'>
                        Explore Premium
                    </p>
                    <p className='bg-black text-white py-1 px-3 rounded-2xl text-[15px] cursor-pointer'>Install App</p>
                    <p className='bg-purple-500 text-white w-7 h-7 rounded-full flex items-center justify-center text-sm font-bold cursor-pointer'>
                        R
                    </p>
                </div>
